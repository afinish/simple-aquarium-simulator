...
public class Fish extends Thread {
	...
	static final int FISH_STEPS = 7; // fish movement duration if not interrupted
	...
	public void run() {
		while(lifetime > 0) {
			...
			while(k > 0) {
				...
				FishTank.updatePosition(x, y, gender); // update the position of the fish in the tank
				
				try {Thread.sleep(200);}
				catch (InterruptedException e) {e.printStackTrace();} // fish velocity
				k--;
			}
//			try {Thread.sleep(200);}
